...
# Perdas ativas								
	...
	minimize fo_correntes_subestacao: sum {i in Ob, t in Ot : Tipo[i] == 0} dT * tarifa_branca[t] * preco_energia * 
					((ISra[i,t]^2 + ISia[i,t]^2) + (ISrb[i,t]^2 + ISib[i,t]^2) + (ISrc[i,t]^2 + ISic[i,t]^2));
